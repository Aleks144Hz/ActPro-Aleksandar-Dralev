...
namespace ActPro.Services.Interfaces
{
    public interface IReservationService
    {
        ...
        Task<List<UserReviewItemViewModel>> GetUserReviewsAsync(string userId);
        Task<UserReservationsViewModel> GetUserReservationsAsync(string userId, int page, int pageSize, string filter);

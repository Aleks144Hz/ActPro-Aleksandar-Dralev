...
namespace ActPro.Services.Interfaces
{
    public interface IEmailSender : Microsoft.AspNetCore.Identity.UI.Services.IEmailSender
    {
        ...
        Task SendBookingCancellationToOwnerAsync(string ownerEmail, string ownerName, string placeName, string customerName, string date, string timeSlot, string number);
